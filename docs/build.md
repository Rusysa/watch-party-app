...
`vX.Y.Z`. El instalador de `v0.1.0` era para todo el equipo: desinstálalo e
instala `v0.2.1` por usuario. Si tienes `v0.2.0`, instala `v0.2.1` manualmente
desde Releases para sustituir su actualizador sin confirmación. Desde `v0.2.1`,
la aplicación solo consulta si hay nuevas versiones; pregunta antes de
descargar, instalar y reiniciar. «Ahora no» pospone el aviso hasta otro inicio.
